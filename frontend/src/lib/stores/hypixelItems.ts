...
const MATERIAL_TO_TEXTURE: Record<string, string> = {
  ...
  SHARD_GHOST: 'item/prismarine_shard',
  SHARD_DRACONIC: 'item/prismarine_shard',
  SHARD_ZEALOT: 'item/prismarine_shard',
  SHARD_GOLDFIN: 'item/prismarine_shard',
  SHARD_VORACIOUS_SPIDER: 'item/prismarine_shard',
  SHARD_DREADWING: 'item/prismarine_shard',
  SHARD_SEER: 'item/prismarine_shard',
  SHARD_BIRRIES: 'item/prismarine_shard',
  SHARD_BARBARIAN_DUKE_X: 'item/prismarine_shard',
