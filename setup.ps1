...
# 1. 백엔드 패키지 설치
Write-Host "`n[1/2] 백엔드 패키지 설치 중..." -ForegroundColor Yellow
...
# 2. 프론트엔드 패키지 설치 및 빌드
Write-Host "`n[2/2] 프론트엔드 설정 중..." -ForegroundColor Yellow
...
# 3. 데이터베이스 마이그레이션
Write-Host "`n[3/3] 데이터베이스 마이그레이션..." -ForegroundColor Yellow
Set-Location $backendPath
